        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="alert bg-light border border-white shadow round col-8 mx-auto p-4"> 
                    ...
                    <form action="/agregarProducto" method="post" class="form-control">
                    @csrf
                    ...
                    @endforeach
                        ...
                        Stock: 
                            <br>
                            <input type="number" name="prdStock" value="{{ old('prdStock') }}" class="form-control">
                        ...
                        Descripción:
                            <textarea name="prdDetalles" class="form-control"></textarea>
